    ...
    <div class="row">
                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Madhukar Reddy</a>
                            <i class="brand_network"><small><small>Madhukar Reddyk</small></small></i>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@madhukarreddy.com</p>
                                                        <div class="divider">
                                                        </div>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Learn DevOps quickly with Madhukar Reddy.</p>
                            <hr>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@madhukarreddy.com</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
